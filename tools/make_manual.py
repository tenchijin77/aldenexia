...
NPCS = [
    ...
    ("Borgrim Emberforge", "Dwarf smith, Crafters' Row (in Lumora)", "Every Blacksmithing pattern he'll teach an outsider, including the Copperlink mail and Bronzeguard plate sets, and a Miner's Pick. Blunt, proud of good work, rude about bad work."),
    ("Lira Solarpetal", "Apothecary, by the Dawnspire Altar (in Lumora)", "Alchemy and brewing: kits, crystal vials, and the Alchemy and Brewing recipe scrolls. Always short of rarer reagents."),
    ("Tobble Cogfarrow", "Gnome tinkerer, Crafters' Row (in Lumora)", "The Tinkering and Jewelcrafting kits and recipes, the Large Crafting Bag, and the compass (the one thing he considers finished)."),
    ("Archivist Ilsabet Thornmere", "Scribe of the Oasis Wardens, the Archive (in Lumora)", "Spell scrolls for the light and neutral classes, and language primers. Precise, formal, and will correct your spelling."),
    ("Xalvyr Tenn", "Vol'kyne copyist, the Sandveil Bazaar (in Lumora)", "Spell scrolls for the dark classes, and language primers. Tolerated in Lumora only under Zyra Sandveil's protection. “Coin acknowledges no gods.”"),
    ("Oswin Coinwright", "Banker, the Treasury Office (in Lumora)", "Right-click him to open your bank."),
    ("Magistrate Corvane", "The Courthouse (in Lumora)", "Pay off a bounty here, and once your record is clear, make amends for the standing your crimes cost with the Wardens."),
    ("High Priestess Solenne", "The Temple of the Dawn (in Lumora)", "For a few coppers she heals you fully and cures poisons, disease and curses. The temple cannot raise the dead."),
    ("Innkeeper Dalla Brightwell", "The Sunlit Rest (in Lumora)", "Food and drink. Minstrel Jorren Brightsong, the Troubadours' trainer, plays at her inn."),
    ("Commander Halvar Sunshield", "The Oasisheart Citadel (in Lumora)", "Commands the Oasis Wardens. Keep the peace inside the walls."),
    ("The class trainers", "Lumora's guild halls", "Each sells their class's spell and skill scrolls. The Hall of Arms: Blademaster, Lightsworn, Aetherfist, Woodstalker. The Lycaeum Annex: Arcanist, Runecaster, Chaosborn. The Temple of the Dawn: Lightmender, Spiritweaver, Wildspeaker. The Lantern Lodge in Old Town: Voidknight, Gravecaller. By the Cisterns: the Shadowblade. The Sunlit Rest: the Troubadour."),
    ("Crier Pell", "By the Paladin's Vigil (in Lumora)", "Calls out the news every few minutes. The notice board in Citadel Plaza has more."),
    ("Wenna Tuller", "Ralph's Last Round, at the Outskirts gate", "Pours drinks at the gate tavern. Nobody touches Ralph's tankard."),
    ...
    ("Sahren of the Deep Wells", "Travelling Djhanid merchant", "Walks a long loop through Solgrave every 90 minutes: into the Outskirts by the southern pass, to the docks, then the town gate; on to the Dustwind Plateaus (the Stone Circles, the Nomad Camp, the Destroyed Caravan); then the Ashfall Dunes (the Oasis, the Neutral Vendor Camp, the Djhanid Encampment) before coming round again. Ask a guard where he is: they know. Hail him on the road and he'll stop to trade. Sells rare goods and the Djhanid primer, and asks for help releasing the Hollowed. Speak to him in Djhanid and he answers in kind."),
