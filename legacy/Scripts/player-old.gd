...
var magic_missile_scene: PackedScene = preload("res://legacy/Scenes/magic_missile-old.tscn") # Explicit type
var ranged_attack_scene: PackedScene = preload("res://legacy/Scenes/ranged_attack-old.tscn") # Explicit type
...
func _ready():
	...
	if not ResourceLoader.exists("res://legacy/Scenes/ranged_attack-old.tscn"):
		print("ERROR: ranged_attack.tscn not found!")
	if not ResourceLoader.exists("res://legacy/Scenes/magic_missile-old.tscn"):
