...
const CHAT_COMMANDS := [
	...
	["/camp", "Begin a 15-second camp-out to the main menu (interrupted by taking damage)"],
	["/camp desktop", "Camp out and close the game completely (same as /exit)"],
	["/exit", "Camp out and close the game completely (same as /camp desktop)"],
	["/log", "Toggle saving chat to a log file"],
	["/invite [name]", "Invite your target, or a named player (in any zone), to your group"],
	["/trade [name]", "Trade items and coin with your target or a named player (or right-click them)"],
	["/duel [name]", "Challenge your target or a named player to a duel (/dual works too): first to 1 health loses, nobody dies"],
	["/pvp [name]", "Declare PvP on your target or a named player (level 5+, within 5 levels): after 5 seconds, a fight to the death"],
	["/yield", "Give up the duel you're in"],
	...
	["/who", "List every player online in every zone, with level, class and zone"],
